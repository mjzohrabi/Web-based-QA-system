<div class="compare<?=_css?>">
    <div class="question-editors2<?=_css?>">
        ...
        <div style="display: flex">
            <img class="mini-img" src="/uploads/<?=$records[0]['replier'].'.jpg'?>" onerror="src='/image/empty-profile.png'">
            <div>
                <a id="user-0" onmouseover="tooltip_compare_a(<?=$records[0]['replier']?>,0)" class="<?=$records[0]['class']?>" href="/<?=_main_lang?>/page/profile/<?=profile_link($records[0]['replier'],$records[0]['user_name'])?>"><?=$records[0]['user_name']?></a>
        ...
        <div style="position: relative;top:20px;">
            <div class="question-editors2<?=_css?>">
                ...
                <div style="display: flex">
                    ...
                    <div>
                        <a id="user-<?=$i+1?>" onmouseover="tooltip_compare_a(<?=$records[1][$i]['editor_id']?>,<?=$i+1?>)" class="<?=$records[1][$i]['class']?>" href="/<?=_main_lang?>/page/profile/<?=profile_link($records[1][$i]['editor_id'],$records[1][$i]['user_name'])?>"><?=$records[1][$i]['user_name']?></a>
...
<script>
    function tooltip_compare_a(uid,i){
